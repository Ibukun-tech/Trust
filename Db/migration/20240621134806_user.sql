...
CREATE TABLE IF NOT EXISTS accounts (id SERIAL PRIMARY KEY,account_number VARCHAR(50) , user_id INTEGER FOREIGN KEY UNIQUE REFERENCES users(id) ON DELETE CASCADE, balance FLOAT, active BOOLEAN, created_at TIMESTAMP, updated_at TIMESTAMP  )
